...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-[#F5F5F5] pb-10 pt-20 dark:bg-navy lg:pb-20 lg:pt-[120px]">
              ...
              <div className="mb-10 w-full">
                <a href="/#" className="mb-3 inline-block max-w-[90px]">
                  ...
                  src={logo}
                    ...
                    alt="logo"
                    className="max-w-full h-ll dark:hidden"
                  />
                  <img
                    //src="https://cdn.tailgrids.com/2.0/image/assets/images/logo/logo-white.svg"
                    src={logo2}
                    alt="logo"
                    className="max-w-full h-full hidden dark:block"
                  />
                </a>
        ...
        <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            ...
            <hr class="my-6 border-gray-400 sm:mx-auto dark:border-gray-700 lg:my-8" />
            <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://alputotrading.com/" class="hover:underline">Alputo Trading™</a>. All Rights Reserved.</span>
        </div>
      </footer>
    </>
  );
